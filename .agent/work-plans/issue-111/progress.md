...
### Findings
- [ ] (must-fix) ADR-0002 lines 72 & 103 still say "one-L14-cell margin" — contradicts the corrected "one L14 tile" Decision + boxed note (internal governance-doc contradiction); mechanical cell->tile fix — `cube_bathymetry/docs/decisions/0002-dirty-tile-footprint-math.md:72`
